...
import com.hannah.hannahmall.search.config.HannahmallElasticSearchConfig;
...
public class ProductSaveService {
    ...
    public boolean productUp(List<SkuEsModel> skuEsModels) throws IOException {
        ...
        BulkResponse responses = restHighLevelClient.bulk(bulkRequest, HannahmallElasticSearchConfig.COMMON_OPTIONS);
