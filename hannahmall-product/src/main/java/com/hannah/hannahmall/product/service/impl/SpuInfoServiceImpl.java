...
import com.hannah.hannahmall.common.exception.RRException;
import com.hannah.hannahmall.common.feign.CouponServiceAPI;
import com.hannah.hannahmall.common.feign.SerachServiceAPI;
import com.hannah.hannahmall.common.feign.WareServiceAPI;
...
import com.hannah.hannahmall.product.dao.*;
import com.hannah.hannahmall.product.entity.*;

import com.hannah.hannahmall.product.service.*;
import com.hannah.hannahmall.product.vo.*;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        if (stockVos.size() == 0) {
            throw new RRException(HannahmallExceptinCodeEnum.WARE_SETTING_ERROR);
        }
...
//            });
        ...
        if (0 == resultBody.getCode()) {
            ...
            throw new RRException(HannahmallExceptinCodeEnum.PRODUCT_UP_ERROR);
        }
    }
    ...
    public void savesupInfo(SpuSaveVo vo) {
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item -> {
                ...
                List<com.hannah.hannahmall.product.vo.Attr> attr = item.getAttr();
