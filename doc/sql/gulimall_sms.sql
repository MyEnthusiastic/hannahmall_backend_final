...
CREATE TABLE `sms_seckill_session`  (
  ...
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '启用状态 1 启用 2  结束',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '秒杀活动场次' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (2, '10月27日上午场', '2020-10-27 02:00:00', '2020-10-27 03:00:00', 2, NULL, NULL);
INSERT INTO `sms_seckill_session` VALUES (3, 'sda', '2020-10-05 15:00:00', '2020-10-21 16:00:00', 2, '2020-10-26 18:11:39', '2020-10-26 18:11:39');
INSERT INTO `sms_seckill_session` VALUES (4, '11.2下午场', '2020-11-03 00:00:00', '2020-11-02 16:00:00', 1, '2020-11-02 10:35:24', '2020-11-02 10:35:24');
INSERT INTO `sms_seckill_session` VALUES (5, '11-10上午场', '2020-11-13 16:39:00', '2020-11-13 23:00:00', 1, '2020-11-02 15:21:44', '2020-11-13 16:37:43');
...
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES (2, 2, 5, 17, 2, 5, 2, 2);
