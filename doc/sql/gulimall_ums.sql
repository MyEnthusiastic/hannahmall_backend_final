...
CREATE TABLE `ums_member`  (
  ...
  `social_uid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '第三方登录后携带的唯一id',
  `access_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '第三方token',
  `expires_in` bigint(0) NULL DEFAULT NULL COMMENT '第三方token过期时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_username`(`username`) USING BTREE,
  INDEX `index_mobile`(`mobile`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000000000000234344 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '会员' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, NULL, NULL, NULL, '力高林百万', NULL, NULL, 'https://tvax3.sinaimg.cn/crop.0.0.888.888.50/b19a0c05ly8fus2jqe4fhj20oo0oojsm.jpg?KID=imgbed,tva&Expires=1598957544&ssig=bg5nSAD7f4', 1, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, '2979662853', '2.00R73ePD052t7u4b1112bac2Eq635C', 157679999);
INSERT INTO `ums_member` VALUES (1000000000000234343, NULL, 'linrucheng', '$2a$10$xpxx7QYbXAdE8JoKvxb0eO6tzD1/LoYfVAyE5/RGMJg6ZIEr610C6', 'gl_5e203cc0', '18356024597', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 1000000000000234343, '林汝诚', '18356024597', '233200', '安徽省', '合肥市', '瑶海区', '瑶海区文一云河湾', '34', 1, '家里');
INSERT INTO `ums_member_receive_address` VALUES (2, 1000000000000234343, '林汝诚', '18356024597', '233200', '安徽省', '合肥市', '蜀山区', '讯飞大厦A5', '34', 0, '公司');
