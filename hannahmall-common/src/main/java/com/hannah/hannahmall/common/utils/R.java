...
public class R extends HashMap<String, Object> {
    ...
    public static R error(HannahmallExceptinCodeEnum HannahmallExceptinCodeEnum) {
        R r = new R();
        r.put("code", HannahmallExceptinCodeEnum.getCode());
        r.put("msg", HannahmallExceptinCodeEnum.getMessage());
        return r;
    }
